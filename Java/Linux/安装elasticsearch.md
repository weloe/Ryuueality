...
# 进入容器内部
2fa7f746546c
docker exec -it 93856222ef41 /bin/bash
...
在线安装的IK的config文件夹在docker内ES目录里的config目录里,在那里配就行
...
![image-20220714144434927](%E5%AE%89%E8%A3%85elasticsearch.assets/image-20220714144434927.png)
